...
#            """ Menu method for placing a new order. """ 
    ...
    def change_working_date_day_month(self, working_date, logic="STARTING"):
    ...
    def change_working_date_day_month_year(self, working_date, logic="STARTING"):
        set_out_day = int(input("Set a day of month as {} date: ".format(logic)))
        working_date[0] = set_out_day
        set_out_month = int(input("Set month as {} date: ".format(logic)))
        working_date[1] = set_out_month
    ...
    def outdate_confirmation(self, working_date):    
    ...
    def start_and_return_confirmation(self, start_date, return_date):
    #    from datetime import datetime
    ...
    def date_validation(self, working_date, reference_date, working_date_saved):
    ...
    def get_starting_date(self, order, working_date_out, this_is_today):
    ...
    def get_return_date(self, order, working_date):
        outdate = datetime.date(working_date[2], working_date[1], working_date[0])
        outdate_weekday = calendar.day_name[outdate.weekday()]
        outdate_month = calendar.month_name[outdate.month]
        print_header()
    ...
    def get_clashing_orders(self, list_of_order_objects, out_date_car1, return_date_car1):
    ...
    def get_clean_list(self, list_of_all_cars, clashing_orders):
        working_list =  []
    ...
    def filter_list(self, working_list, brand="", category="", registration_date=""):
    ...
    def available_car_printout(self, filtered_working_list):
    ...
    def choose_car_from_list(self, filtered_working_list):
        if filtered_working_list == []:
    ...
    def car_confirmation_prompt(self, order, final_list, selection_as_index):
    ...
    def search_filters(self, list_of_all_cars,filter_dummy,all_brands, all_categories, all_registration_dates):
        filter_values = []
        if filter_dummy == 0:
            filter_values = ["","",""]
        else:
    ...
    def get_all_brands(self, list_of_all_cars):
        brand_set = set()
        for car in list_of_all_cars:
            brand_set.add(car.get_brand())
        return brand_set

    def get_all_categories(self, list_of_all_cars):
        category_set = set()
        for car in list_of_all_cars:
            category_set.add(car.get_category())
        return category_set

    def get_all_registration_dates(self, list_of_all_cars):
        registration_date_set = set()
        for car in list_of_all_cars:
            registration_date_set.add(car.get_registration_date())
        return registration_date_set

    def filter_menu(self, brands, categories, registration_dates):
        filter_list = []
